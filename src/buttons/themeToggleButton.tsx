...
export const ThemeToggleButton : FC<{
  ...
  const scaleMoon = useMotionValue(moonVariants.visible.scale);
  const scaleSun = useMotionValue(sunVariants.visible.scale);
  // scaleMoon.onChange(() => {
  //   console.log(`Moon is at scale ${scaleMoon.get()}`);
  // });
  // scaleSun.onChange(() => {
  //   console.log(`Sun is at scale ${scaleSun.get()}`);
  // });

  // See
  // https://www.framer.com/docs/use-transform/
  // When scaleMoon is 0.6, pathLength = 0 ;
  // when scaleMoon is 1, pathLength = 1
